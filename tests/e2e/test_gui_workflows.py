...
class TestPresetWorkflows(BaseGUIWorkflowTest):
    ...
    def test_preset_file_workflow(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            preset_data = {
                ...
                "parameters": {
                    ...
                    "general": {"analysis_mode": original_params.analysis_mode},
                },
            }
        ...
        try:
            ...
            assert (
                loaded_data["parameters"]["hydrogen_bonds"]["h_a_distance_cutoff"]
                == 3.1
            )
...
class TestVisualizationWorkflows(BaseGUIWorkflowTest):
    ...
    def test_chain_visualization_integration(self):
        ...
        try:
            from hbat.gui.chain_visualization_window import ChainVisualizationWindow  # noqa: F401
