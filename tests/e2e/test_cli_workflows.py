...
import json
import sys
from hbat.cli.main import create_parser, load_parameters_from_args, load_preset_file
...
class TestCLIAnalysisWorkflows:
    ...
    def test_basic_cli_analysis_workflow(self, sample_pdb_file):
        ...
        args = parser.parse_args(
            [sample_pdb_file, "--hb-distance", "3.5", "--hb-angle", "120"]
        )
    ...
    def test_cli_output_format_workflow(self, sample_pdb_file):
        ...
        try:
            ...
            args = parser.parse_args(
                [sample_pdb_file, "--json", json_path, "--csv", csv_path, "--verbose"]
            )
    ...
    def test_cli_pdb_fixing_workflow(self, pdb_fixing_test_file):
        ...
        )  # Should have some interactions after fixing
        ...
        try:
            ...
            override_args = parser.parse_args(
                [
                    sample_pdb_file,
                    "--hb-distance",
                    "3.5",  # Override preset value
                ]
            )

            override_params = load_parameters_from_args(override_args)
            assert (
                override_params.hb_distance_cutoff == 3.5
...
class TestCLIValidationWorkflows:
    ...
    def test_parameter_validation_workflow(self, sample_pdb_file):
        ...
        test_cases = [
            ...
            (
                [sample_pdb_file, "--hb-distance", "0.8"],
                True,
            ),  # Small distance within valid range
    ...
    def test_cli_performance_workflow(self, sample_pdb_file):
        ...
        args = parser.parse_args(
            [
                sample_pdb_file,
                "--mode",
                "complete",  # Most comprehensive analysis
            ]
        )
