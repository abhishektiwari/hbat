...
class TestNPiInteractionSubtypes:
    ...
    def test_carbonyl_aromatic_interaction(self, various_donor_atoms, pi_system_atoms):
        ...
        n_pi = NPiInteraction(
            lone_pair_atom=carbonyl_oxygen,
            pi_center=pi_center,
            pi_atoms=pi_atoms,
            distance=3.2,
            angle_to_plane=20.0,
    ...
    def test_amine_aromatic_interaction(self, various_donor_atoms, pi_system_atoms):
        ...
        n_pi = NPiInteraction(
            lone_pair_atom=amine_nitrogen,
            pi_center=pi_center,
            pi_atoms=pi_atoms,
            distance=3.8,
            angle_to_plane=25.0,
            subtype="amine-aromatic",
        )
    ...
    def test_sulfur_aromatic_interaction(self, various_donor_atoms, pi_system_atoms):
        ...
        n_pi = NPiInteraction(
            lone_pair_atom=sulfur_atom,
            pi_center=pi_center,
            pi_atoms=pi_atoms,
            distance=4.0,
            angle_to_plane=35.0,
            subtype="sulfur-aromatic",
        )
    ...
    def test_hydroxyl_aromatic_interaction(self, various_donor_atoms, pi_system_atoms):
        ...
        n_pi = NPiInteraction(
            lone_pair_atom=hydroxyl_oxygen,
            pi_center=pi_center,
            pi_atoms=pi_atoms,
            distance=3.6,
            angle_to_plane=18.0,
            subtype="hydroxyl-aromatic",
        )
...
class TestNPiInteractionString:
    ...
    def test_n_pi_interaction_different_elements(self):
        ...
        n_pi = NPiInteraction(
            lone_pair_atom=nitrogen_atom,
            pi_center=pi_center,
            pi_atoms=pi_atoms,
            distance=4.15,
            angle_to_plane=18.0,
            subtype="amine-phenyl",
        )
