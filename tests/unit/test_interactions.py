...
class TestPiInteractionTypeDisplay:
    ...
    def create_test_atom(
        self, name: str, element: str, x: float = 0.0, y: float = 0.0, z: float = 0.0
    ) -> Atom:
...
class TestCooperativityChainCreation:
    ...
    def test_cooperativity_chain_creation(self, sample_interactions):
        ...
        chain = CooperativityChain(
            interactions=interactions, chain_length=2, chain_type="H-bond chain"
        )
    ...
    def test_empty_cooperativity_chain(self):
        ...
        chain = CooperativityChain(interactions=[], chain_length=0, chain_type="Empty")
...
class TestCooperativityChainString:
    ...
    def test_empty_chain_string_representation(self):
        ...
        chain = CooperativityChain(interactions=[], chain_length=0, chain_type="")
