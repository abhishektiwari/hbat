...
class TestGraphVizDetector:
    ...
    def test_is_graphviz_available_not_found(self):
        ...
        with (
            patch.object(GraphVizDetector, "_which", return_value=None),
            patch.object(
                GraphVizDetector, "_check_executable_in_directory", return_value=False
            ),
        ):
            result = GraphVizDetector.is_graphviz_available()
    ...
    def test_is_graphviz_available_found_in_platform_path(self):
        ...
        with (
            patch.object(GraphVizDetector, "_which", return_value=None),
            patch.object(
                GraphVizDetector, "_check_executable_in_directory", return_value=True
            ),
    ...
    def test_is_graphviz_available_caching(self):
        ...
        with patch.object(
            GraphVizDetector, "_which", return_value="/usr/bin/dot"
        ) as mock_which:
            # First call
    ...
    def test_get_graphviz_version_success(self):
        ...
        with (
            patch.object(GraphVizDetector, "is_graphviz_available", return_value=True),
    ...
    def test_get_graphviz_version_not_available(self):
        ...
        with patch.object(
            GraphVizDetector, "is_graphviz_available", return_value=False
        ):
            version = GraphVizDetector.get_graphviz_version()
    ...
    def test_get_available_engines_success(self):
        ...
        with (
            ...
            patch.object(
                GraphVizDetector,
                "_check_executable_in_path",
                side_effect=mock_check_path,
            ),
            patch.object(
                GraphVizDetector,
                "_check_executable_in_directory",
                side_effect=mock_check_directory,
            ),
        ):
    ...
    def test_validate_engine_valid(self):
        ...
        with patch.object(
            GraphVizDetector, "get_available_engines", return_value=["dot", "neato"]
        ):
    ...
    def test_check_executable_in_directory_found(self):
        ...
        with patch(
            "hbat.utilities.graphviz_utils.Path", side_effect=mock_path_constructor
        ):
    ...
    def test_check_executable_in_directory_not_found(self):
        ...
        with patch(
            "hbat.utilities.graphviz_utils.Path", return_value=mock_path_constructor
        ):
            result = GraphVizDetector._check_executable_in_directory("dot", "/usr/bin")
            assert result is False
    ...
    def test_check_executable_in_directory_windows(self):
        ...
        with (
            ...
            result = GraphVizDetector._check_executable_in_directory(
                "dot", r"C:\Program Files\Graphviz\bin"
            )
            assert result is True
...
class TestGetGraphVizInfo:
    ...
    def test_get_graphviz_info_complete(self):
        ...
        with (
            patch.object(GraphVizDetector, "is_graphviz_available", return_value=True),
            patch.object(
                GraphVizDetector, "get_graphviz_version", return_value="2.44.1"
            ),
            patch.object(
                GraphVizDetector, "get_available_engines", return_value=["dot", "neato"]
            ),
    ...
    def test_get_graphviz_info_not_available(self):
        ...
        with (
            patch.object(GraphVizDetector, "is_graphviz_available", return_value=False),
