...
class TestCarbonylInteractionAngles:
    ...
    def test_angle_property_conversion(self, carbonyl_atoms):
        ...
        carbonyl = CarbonylInteraction(
            ...
            acceptor_oxygen=acceptor_oxygen,
            distance=3.2,
            burgi_dunitz_angle=angle_degrees,
            is_backbone=True,
        )
...
class TestCarbonylInteractionTypes:
    ...
    def test_backbone_backbone_interaction(self, mixed_carbonyl_atoms):
        ...
        carbonyl = CarbonylInteraction(
            donor_carbon=bb_carbon,
            donor_oxygen=bb_oxygen,
            acceptor_carbon=bb_carbon,
            acceptor_oxygen=bb_oxygen,
            distance=3.2,
            burgi_dunitz_angle=107.0,
            is_backbone=True,
        )
    ...
    def test_sidechain_sidechain_interaction(self, mixed_carbonyl_atoms):
        ...
        carbonyl = CarbonylInteraction(
            donor_carbon=sc_carbon,
            donor_oxygen=sc_oxygen,
            acceptor_carbon=sc_carbon,
            acceptor_oxygen=sc_oxygen,
            distance=3.5,
            burgi_dunitz_angle=102.0,
            is_backbone=False,
        )
...
class TestCarbonylInteractionDistances:
    ...
    def test_donor_interaction_distance(self):
        ...
        donor_oxygen = Atom(
            ...
            res_seq=1,
            i_code="",
            coords=NPVec3D(1.23, 0, 0),
            occupancy=1.0,  # Typical C=O bond
            temp_factor=20.0,
            element="O",
            charge="",
            record_type="ATOM",
...
class TestCarbonylInteractionValidation:
    ...
    def test_carbonyl_atoms_retrieval(self):
        ...
        with pytest.raises(
            ValueError, match="Carbonyl type must be 'donor' or 'acceptor'"
        ):
