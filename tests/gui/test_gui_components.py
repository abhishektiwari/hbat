...
class TestGeometryCutoffsDialog:
    ...
    def test_preset_manager_integration(self):
        ...
        try:
            ...
            with patch(
                "hbat.gui.preset_manager_dialog.PresetManagerDialog"
            ) as mock_preset:
                mock_instance = Mock()
    ...
    def test_reset_to_defaults_no_errors(self):
        ...
        test_params = AnalysisParameters(hb_distance_cutoff=3.2, hb_angle_cutoff=125.0)
        dialog = GeometryCutoffsDialog(self.root, test_params)
        ...
        try:
            ...
            result_params = dialog.get_parameters()
            assert (
                result_params.hb_distance_cutoff == ParametersDefault.HB_DISTANCE_CUTOFF
            )
    ...
    def test_category_switching_preserves_changes(self):
        ...
        try:
            ...
            initial_params = AnalysisParameters(
                hb_distance_cutoff=3.3, hb_angle_cutoff=135.0
            )
    ...
    def test_main_window_creation(self):
        ...
        try:
            ...
            assert hasattr(main_window, "results_panel"), (
                "MainWindow should have results_panel attribute"
            )
            assert hasattr(main_window, "analyzer"), (
                "MainWindow should have analyzer attribute"
            )
            assert main_window.session_parameters is None, (
                "session_parameters should be initialized as None"
            )

            # Test that menu actions exist for new dialogs
            assert hasattr(main_window, "_open_parameters_window"), (
                "Should have _open_parameters_window method"
            )
            assert hasattr(main_window, "_open_pdb_fixing_window"), (
                "Should have _open_pdb_fixing_window method"
            )
...
class TestGUIImports:
    ...
    def test_gui_module_imports(self):
        ...
        try:
            from hbat.gui.main_window import MainWindow  # noqa: F401
            from hbat.gui.geometry_cutoffs_dialog import GeometryCutoffsDialog  # noqa: F401
            from hbat.gui.pdb_fixing_dialog import PDBFixingDialog  # noqa: F401
            from hbat.gui.preset_manager_dialog import PresetManagerDialog  # noqa: F401
            from hbat.gui.results_panel import ResultsPanel  # noqa: F401
